  ...
  return (
    ...
    >
      <fieldset className="w-full">
        <legend className="sr-only">Choose an option for: {question.question}</legend>
        <div className="flex items-start gap-4 mb-6" aria-hidden="true">
            ...
            return (
              ...
              >
                ...
                <div className="flex items-center">
                  ...
                  {isSubmitted && isCorrectOption && <CheckCircle2 className="w-5 h-5 text-emerald-500 dark:text-emerald-400" aria-label="Correct" />}
                  {isSubmitted && isWrongSelection && <XCircle className="w-5 h-5 text-rose-500 dark:text-rose-400" aria-label="Incorrect" />}
                </div>
                <input
                  type="radio"
